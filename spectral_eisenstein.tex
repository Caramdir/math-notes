...
\renewcommand\Eis[2][]{\operatorname{Eis}_{#2}^{#1}}   % \Eis_P^G
\renewcommand\CT[2][]{\operatorname{CT}^{#2}_{#1}}     % \CT_G^P
...
\begin{Claim}
    If $\Eis[M]{P_M} ∘ \CT[L]{Q_L} \sheaf F = 0$, then $\STf[w] PQ \sheaf F = 0$ (where $w$ corresponds to the orbit of $(P,Q)$).
\end{Claim}
